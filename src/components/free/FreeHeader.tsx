...
export function FreeHeader() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 bg-white border-b border-gray-200 z-50">
      <div className="bg-gradient-to-r from-green-600 to-emerald-600 text-white py-2 px-4 text-center text-sm font-semibold">
        🎉 Special Offer: $99 Website for First 5 Singapore Businesses - Only 3 Spots Left!
      </div>
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden lg:flex items-center gap-8">
            ...
            >
              <button className="flex items-center gap-1 text-gray-700 hover:text-emerald-600 font-semibold transition-colors">
                Services
        ...
        {mobileMenuOpen && (
          <div className="lg:hidden py-4 border-t border-gray-200 animate-in fade-in slide-in-from-top-4 duration-200">
            <div className="flex flex-col gap-1">
              <a
                href="/"
                className="px-4 py-3 text-gray-700 hover:bg-emerald-50 hover:text-emerald-600 font-semibold rounded-lg transition-colors"
              >
                Home
              </a>
              <a
              ...
              <div>
                <button
                  ...
                  className="w-full flex items-center justify-between px-4 py-3 text-gray-700 hover:bg-emerald-50 hover:text-emerald-600 font-semibold rounded-lg transition-colors"
                >
                  Services
              ...
              <div className="border-t border-gray-200 mt-2 pt-2">
                ...
                <a
                  href="#apply"
                  className="block px-4 py-3 bg-emerald-600 text-white font-semibold rounded-lg hover:bg-emerald-700 transition-colors text-center"
                >
                  Apply Now
                </a>
              </div>
